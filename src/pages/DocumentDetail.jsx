          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {summary && (
              <Card>
                ...
                <CardContent>
                  <p className="text-foreground leading-relaxed mb-6">{summary.plain_summary}</p>
            ...
            {!document.processed && (
              <Card className="border-2 border-dashed">
                <CardContent className="py-12 text-center">
                  ...
                  <p className="text-muted-foreground mb-4">Click "Analyze with AI" to get your summary and risk analysis</p>
                </CardContent>
              </Card>
            )}
          </div>
                  ...
                  <div className="space-y-4">
                    {riskFlags.map((risk) => (
                      <div key={risk.id} className="space-y-2">
                        ...
                        {risk.excerpt && <p className="text-xs bg-muted p-2 rounded italic">"{risk.excerpt}"</p>}
                      </div>
                    ))}
                  </div>
                ) : (
                  <p className="text-sm text-muted-foreground text-center py-4">
                    {document.processed ? 'No risks detected in this document' : 'Risk analysis pending'}
                  </p>
                )}
              </CardContent>
            </Card>
